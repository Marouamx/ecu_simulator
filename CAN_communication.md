## CAN COMMUNICATION BETWEEN 2 STM32F4 MICROCONTROLLERS
...
For the circuit use the STM32F4 discovery shield that has already the CAN tranceiver implemented on it.
